      ...
      <div class='flex flex-wrap items-center justify-between py-3 px-4 sm:px-10 bg-[#151d20] lg:gap-y-4 gap-y-6 gap-x-4'>
        ...
        <div id="collapseMenu"
          ...
          <ul
            ...
            <Link to="/"
              ...
              <a href='javascript:void(0)' class='text-white block text-[15px] font-medium'>Home</a>
            </Link>
            <Link to="/aboutus"
              ...
              <a href='javascript:void(0)' class='text-white block text-[15px] font-medium'>AboutUs</a>
            </Link>
            <Link to="/contactus"
              class='max-lg:border-b max-lg:py-3 relative lg:hover:after:absolute lg:after:bg-white lg:after:w-0 lg:hover:after:w-full lg:hover:after:h-[2px] lg:after:block lg:after:-bottom-4 lg:after:transition-all lg:after:duration-300'>
              <a href='javascript:void(0)' class='text-white block text-[15px] font-medium'>Contact US</a>
            </Link>
            <Link to="/allrooms"
              class='max-lg:border-b max-lg:py-3 relative lg:hover:after:absolute lg:after:bg-white lg:after:w-0 lg:hover:after:w-full lg:hover:after:h-[2px] lg:after:block lg:after:-bottom-4 lg:after:transition-all lg:after:duration-300'>
              <a href='javascript:void(0)' class='text-white block text-[15px] font-medium'>Rooms</a>
            </Link>
            <Link to="/team"
              class='max-lg:border-b max-lg:py-3 relative lg:hover:after:absolute lg:after:bg-white lg:after:w-0 lg:hover:after:w-full lg:hover:after:h-[2px] lg:after:block lg:after:-bottom-4 lg:after:transition-all lg:after:duration-300'>
              <a href='javascript:void(0)' class='text-white block text-[15px] font-medium'>Team</a>
            </Link>
        ...
        <div class='flex items-center max-sm:ml-auto'>
          <ul class="flex space-x-4">
            ...
            <Link to="/signin"
              class="relative text-white px-1 lg:hover:after:absolute lg:after:bg-white lg:after:w-0 lg:hover:after:w-full lg:hover:after:h-[2px] lg:after:block lg:after:-bottom-4 lg:after:transition-all lg:after:duration-300">
            Sign In
