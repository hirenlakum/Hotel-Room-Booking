        ...
        <form class="bg-opacity-70  bg-white rounded p-6 shadow-[0_2px_16px_-3px_rgba(125,126,131,0.3)]" onSubmit={handleSubmit(onSubmit)} >
          ...
          <div>
            <div class="relative flex flex-col items-center">
              ...
              {...register('userName',{
                ...
                minLength:{value:3,message:'username atleast 3 letter long'}
              })}
          ...
          <div>
            <div class="relative flex flex-col items-center">
              <input 
              {...register('image',{
                required:{value:true,message:'Please Upload an Profile Image'}
              })}
...
{...register('password',{
  ...
  minLength:{value:3,message:'password must be 3 numbers long'},
          ...
          <div class="flex flex-wrap items-center justify-between gap-4 mt-6">
           ...
           <div class="mt-12">
            ...
            <p class="text-gray-800 text-sm text-center mt-6">Don't have an account <Link to="/signin"
              class="text-blue-600 font-semibold hover:underline ml-1 whitespace-nowrap">Sign In Here</Link></p>
          </div> 
