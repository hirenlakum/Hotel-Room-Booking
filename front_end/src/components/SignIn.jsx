  ...
  return (
    ...
    <div class="flex justify-center items-center font-[sans-serif] h-full min-h-screen p-4 bg-[url('img/back.png')] bg-cover bg-no-repeat">
      <div class="max-w-md w-full mx-auto">
        <form  onSubmit={handleSubmit(onSubmit)} class="bg-opacity-70  bg-white rounded p-6 shadow-[0_2px_16px_-3px_rgba(125,126,131,0.3)]" >
          <div class="mb-12">
          ...
          <div>
            <div class="relative flex flex-col items-center">
              <input name="email" type="email"  class="bg-transparent w-full text-sm text-gray-800 border-b border-gray-400 focus:border-gray-800 pl-2 pr-8 py-3 outline-none placeholder:text-gray-800"
          ...
          <div class="mt-6">
            <div class="relative flex flex-col items-center">
              ...
              {...register('password',{
                ...
                minLength:{value:3,message:'password must be at least 3 number long'}
              })}
    ...
    {errors.password && <p className='text-red-500'>{errors.password.message}</p>}
          ...
          <div class="flex flex-wrap items-center justify-between gap-4 mt-6">
           ...
           <div class="mt-12">
            ...
            <p class="text-gray-800 text-sm text-center mt-6">Don't have an account <Link to="/singup"
              class="text-blue-600 font-semibold hover:underline ml-1 whitespace-nowrap">Register here</Link></p>
          </div> 
