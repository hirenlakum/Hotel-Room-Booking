...
const UpdateRoom = () => {
    ...
    const [badType,setBadype] = useState("")
    ...
    formData.append("badtype",badType),
 ...
 axios.get("http://localhost:3011/getEachRoom/"+id)
   ...
   const update = (e) => {
    ...
    axios.post("http://localhost:3011/updateRooms/"+id,formData)
...
<div className='w-[100%] flex  '>
  ...
  <div className='w-screen h-screen flex items-center justify-center'>
     ...
     <form action=""  className='border-2 border-gray-600 inline-block p-[40px] w-[600px]'>
     <h1 className='text-2xl text-green-700 text-center'>Room Update</h1>

     <div className='flex flex-col mb-[20px]'>
      <label htmlFor="image">Room Image</label>
      <img src={`http://localhost:3011/uploads/${image}`} alt="" className='w-[200px] h-[200px]' />
      <input type="file" className='mt-[20px]'
     onChange={(e)=>setImage(e.target.files[0])}
      ...
      <label htmlFor="image">BadType</label>
      <input type="text"
     onChange={(e)=>setBadype(e.target.value)}
      value={badType} placeholder=''id="image" className='w-[100%] outline-none rounded p-4 h-[50px] border border-blue-400' /><br />
      </div>

      <div className='flex flex-col'>
      <label htmlFor="image">Room Price</label>
      <input type="text"
      value={price}
      onChange={(e)=>setPrice(e.target.value)}
      placeholder=''id="image" className='w-[100%] h-[50px] border rounded p-4 outline-none border-blue-400' /><br />
      </div>

      <div className='flex flex-col'>
      <label htmlFor="image">Room People</label>
      <input type="text"
      value={people}
    onChange={(e)=>setPeople(e.target.value)}
      placeholder=''id="image" className='w-[100%] h-[50px] border outline-none rounded p-4 border-blue-400' /><br />
      </div>

<input type="submit" onClick={update} value="update" className='text-white bg-green-600 w-[120px] h-[40px] rounded'/>
